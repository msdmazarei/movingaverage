...
class SimpleMovingAverageTest {
    ...
    void get_period_for_period_3_should_be_3() {
        IMovingAverage<Integer> movingAverage = new SimpleMovingAverage<Integer>(3);
    ...
    void period_of_zero_should_raise_exception() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
                    new SimpleMovingAverage<Integer>(0);
                }
        );
    ...
    void last_n_items_should_be_997_998_999_after_adding_1000_items_sequentialy() {
        IMovingAverage<Integer> s = new SimpleMovingAverage<Integer>(3);
    ...
    void last_n_items_for_sin_func() {
        IMovingAverage<Double> s = new SimpleMovingAverage<Double>(500);
    ...
    void getAllItems() {
        Assertions.assertThrows(
                NotImplementedException.class, () -> {
                    new SimpleMovingAverage<Integer>(10).getAllItems();
                }
        );
    }
    ...
    void moving_average_of_seq_1_to_1000_and_period_of_5() {
        IMovingAverage<Integer> movingAverage = new SimpleMovingAverage(5);
    ...
    void moving_average_of_seq_1_to_1000000_and_period_of_500() {
        IMovingAverage<Long> movingAverage = new SimpleMovingAverage(500);
    ...
    void moving_average_of_sin_of_seq_1_to_1000000_and_period_of_500() {
        IMovingAverage<Double> movingAverage = new SimpleMovingAverage(500);
    ...
    void moving_average_of_seq_1_to_999_and_period_of_1_should_be_999() {
        IMovingAverage<Integer> movingAverage = new SimpleMovingAverage(1);
